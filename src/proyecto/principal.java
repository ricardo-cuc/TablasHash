...
public class principal {
	public static void main (String[] args) throws Exception {
		...
		HashTab  PersonasLinkList = new PersonasLinkList();
				
			BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\Ricardo\\eclipse-workspace\\Examen\\src\\proyecto\\PersonasLinkListC.csv")); 
			String line;
			while ((line = br.readLine()) != null) { 
			    // use comma as separator 
			    String[] cols = line.split(";"); 
				Persona pers = new Persona(Integer.parseInt(cols[0]), cols[1], cols[2]);
